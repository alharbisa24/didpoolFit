...
import 'package:ui_tutorial/onboarding/second.dart';

class FirstOnBoardingScreenWidget extends StatelessWidget {
  const FirstOnBoardingScreenWidget({super.key});
...
Align(
      ...
      ArcArrowButton(onPressed: (){
        ...
        Navigator.of(context).push(MaterialPageRoute(builder: (context) => SecondOnBoardingScreenWidget()));
      },).animate()
            .fadeIn(duration: 600.ms, delay: 400.ms, curve: Curves.easeInOut),
         ],
        )
      ),
    );
...
class ArcPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final paint = Paint()
      ..color = color   // ← ← هنا اللون ثابت بدون تدرج
