...
import 'package:ui_tutorial/onboarding/Register.dart';

class ForthOnBoardingWidget extends StatelessWidget {
  const ForthOnBoardingWidget({super.key});
          ...
          children: [
            ...
            Positioned(
              ...
              child: ArcArrowButton(
                onPressed: () {
               Navigator.of(context).push(MaterialPageRoute(builder: (_) => RegisterWidget()));
                },
              ),
            ).animate()
            .fadeIn(
